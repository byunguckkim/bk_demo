...
class optional {
 ...
 public:
  ...
  operator=(optional const& other) noexcept(
      std11::is_nothrow_move_assignable<T>::value&& std11::is_nothrow_move_constructible<T>::value)
#else
...
#if optional_CPP11_OR_GREATER
      noexcept(
          std11::is_nothrow_move_constructible<T>::value&& std17::is_nothrow_swappable<T>::value)
#endif
  {
    using std::swap;
...
template <typename T>
optional_nodiscard optional_constexpr bool operator==(optional<T> const& x,
...
template <typename T>
optional_nodiscard optional_constexpr bool operator<=(
